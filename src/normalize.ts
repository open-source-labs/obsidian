 ...
 */
const hashMaker = (hashableObject:any, hashableKeys:any):string => {
...
// }
// function (hashableKeys = ["id", "__typename"];)
export const normalizeObject = (nestedObject: GenericObject, hashableKeys:Array<string>, normalizedHashableObjects:any = {}):FlatObject => {
    for(const key in nestedObject){
